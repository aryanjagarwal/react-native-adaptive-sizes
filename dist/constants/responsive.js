...
exports.platformScale = exports.getPlatformInfo = exports.deviceScale = exports.getDeviceInfo = exports.fontScaleWithLimits = exports.fontScale = exports.hp = exports.wp = exports.moderateVerticalScale = exports.moderateScale = exports.verticalScale = exports.scale = exports.setScreenSize = void 0;
...
const platformScale = (values) => {
    if (react_native_1.Platform.OS === 'ios' && values.ios !== undefined)
        return values.ios;
    if (react_native_1.Platform.OS === 'android' && values.android !== undefined)
        return values.android;
    if (react_native_1.Platform.OS === 'web' && values.web !== undefined)
        return values.web;
    return values.default;
};
exports.platformScale = platformScale;
